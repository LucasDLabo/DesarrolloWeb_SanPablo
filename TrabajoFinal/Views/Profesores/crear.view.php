            ...
            <div class= "mx-20 rounded-lg border-2 border-solid border-indigo-500 bg-white px-20 py-8 shadow">
                ...
                <form action="" method="post" id="createProfesor">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" id="nombreCreateProfesor" name="nombre" placeholder="Introduzca el nombre"
                            class="border border-gray-300 shadow p-3 w-full rounded">
                        <p  class="mt-2 text-sm text-indigo-700"></p>
                    </div>

                    <div class="mb-5">
                        <label for="apellido" class="mb-2 block font-bold text-gray-600">Apellido</label>
                        <input type="text" id="apellidoCreateProfesor" name="apellido" placeholder="Introduzca el apellido"
                            class="border border-gray-300 shadow p-3 w-full rounded">
                        <p  class="text-sm text-indigo-700 mt-2"></p>
                    </div>

                    <div class="mb-5">
                        <label for="materiaID" class="mb-2 block font-bold text-gray-600">Materia</label>
                        <select name="materiaID" id="materiaCreateProfesor" class="w-full rounded border border-gray-300 p-3 shadow">
