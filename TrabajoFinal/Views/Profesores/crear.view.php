                    ...
                    <ul
                        ...
                        <li>
                            <button id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar"
                                class="md:text-blue-700 flex items-center justify-between w-full py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 md:w-auto dark:text-blue-500 md:dark:hover:text-blue-500 dark:focus:text-white dark:border-gray-700 dark:hover:bg-gray-700 md:dark:hover:bg-transparent"
                                aria-current="page">
                                Crear
    ...
    <main class="flex-grow">
        <div class="grid grid-cols-6 items-start justify-items-center py-8">
            ...
            <a href="../Profesores/index.php"
                class="w-4/6 rounded bg-blue-900 py-3 text-center text-sm font-bold text-gray-100 hover:bg-blue-800 hover:text-white">
                Volver a Profesores
            </a>

            <div class="w-full col-start-2 col-end-6">
                <div class= "bg-white px-20 py-8 rounded-lg mx-20 ">
                    <h2 class="text-center text-blue-900 font-bold text-2xl uppercase">Ingrese los datos del Profesor
                    </h2>
