...
<body class="flex min-h-screen flex-col">
        ...
        <nav class="border-gray-200 bg-white shadow dark:border-gray-700 dark:bg-gray-900">
            <div class="max-w-screen flex flex-wrap items-center justify-between p-4">
                <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
                    ...
                    <span
                        class="self-center text-xl font-semibold whitespace-nowrap dark:text-white hover:text-blue-500">Ir
                        a la Vista General
                    </span>
                </a>
            ...
            <div class="flex w-auto flex-grow">
                ...
                <div class="w-full px-5">
                    <div class="flex flex-row items-end justify-between">
                        <h1 class="font-bold lg:text-3xl">📚 Lista de Materias</h1>
                        <a href="crear.php">
                            <button
                    ...
                    <hr class="my-3">
                    <table id="listaMaterias" class="stripe table-auto rounded border-2 border-solid border-gray-400">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border"><?= $materia->nombre ?></td>
                                <td class="border">Aca va mas info</td>
    ...
    <script>
        ...
        function confirmar(nombre) {
            return confirm("⚠️ Atención ⚠️ \n¿Estás seguro de que deseas eliminar la materia " + nombre +
                "? \nLa materia será enviada a la papelera.");
        }
    </script>
</body>
